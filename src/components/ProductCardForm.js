const ProductCardForm = () => {
  return (
    <div className="w-[1143px] flex flex-row items-start justify-center text-left text-29xl text-white font-poppins">
      <div className="w-[1132px] h-[516px] flex flex-col items-center justify-center gap-[99px]">
        <div className="w-[1132px] h-[75px] flex flex-col py-0 px-[453px] box-border items-start justify-end">
          <div className="relative tracking-[0.01em] leading-[160%] font-semibold inline-block w-[225px] h-[73px] shrink-0 [text-shadow:0px_4px_4px_rgba(0,_0,_0,_0.25)]">
            Products
          </div>
        </div>
        <div className="w-[1000px] h-[342px] overflow-hidden shrink-0 flex flex-row items-center justify-start gap-[99px] text-base">
